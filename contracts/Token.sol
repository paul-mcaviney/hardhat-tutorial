...
contract Token {
    ...
    string public name = "Fake Hardhat Token";
    string public symbol = "MHT";

    // The fixed amount of tokens stored in an unsigned integer type variable
    uint public totalSupply = 1000000;

    // An address variable used to store ethereum accounts
    address public owner;

    // A mapping is a key/value map. Here we are storing each account balance
    ...
    *
    * The 'view' modifier indicates that it doesn't modify the contract'sstate, which allows us to call it without executing a transaction
    */
