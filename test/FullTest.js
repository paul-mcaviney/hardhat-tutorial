...
// it's not actually needed, but having tests organized makes debugging easier
// All Mocha functions are available in the global scope

// 'describe' receives the name of a section of your test suite, and a callback
// The callback must define the tests of that section
// The callback can't be an async function
describe("Token contract", function () {

    // Mocha has four functions that let you hook into the test runner's lifecycle
    // These are: 'before', 'beforeEach', 'after', 'afterEach'

    // Useful to setup the environment for tests, and to clean it up after they run
    ...
    beforeEach(async function () {
        ...
        // This happens once its transaction has been mined
    ...
    describe("Deployment", function () {
        ...
        // is used to define your tests
        // receives the test name, and a callback function
